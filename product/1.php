...
<div id="page">
        ...
        <div class="gtco-container">
            ...
            <div class="row">
                <div class="col-sm-4 col-xs-12">
                    <div id="gtco-logo"><a href="../index.php">Topprs <em>.</em></a></div>
                </div>
    ...
    <form action="http://www.enrichsalon.com/products/cleaning-material/beardo---mustache-and-beard-wax-50gm/10" method="post"><input name="__RequestVerificationToken" type="hidden" value="spOz1vYkCOAaosS6n3ATMnYZ1EdaXr5bu5GETRQMXFZXGuLb1CxZwVgRRMd3ECm0X6q-Q21oDXXrguG8Y1Q-mcZpW_SqgZ0RBlZadRLYXKM1" />    <div style="min-height:700px;width:100%;" align="center" class="margin-top">
            <div class="div-cart-container">
                <div class="div-prod-detail" align="left">
                    <div class="div-img-block">
                        <div class="flexslider">
                            <ul class="slides">
                                <li data-thumb="../images/Product/8fc2d45f-8e8a-43e1-b710-717c2237143a.jpg">
                                    <img src="../images/Product/8fc2d45f-8e8a-43e1-b710-717c2237143a.jpg" />
                                </li>
                            </ul>
                        </div>
                    </div>

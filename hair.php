...
<div id="page">
            ...
            <div class="col-md-12 col-md-offset-0 text-left">
                <div class="display-t">
                    <div class="display-tc">
                        <h1 class="animate-box" data-animate-effect="fadeInUp">HAIR SERVICES</h1>
                        <h2 class="animate-box" data-animate-effect="fadeInUp">Here now you Can booked your <b>HAIR</b> services..</Services></h2></em></h2></div>
                </div>
            </div>
        </div>
    </header>
    ...
    <div class="row" >
        ...
        <body>
        <form>
            <select name="sct" class="rowrow" class="col-md-8">
                <option>Male</option>

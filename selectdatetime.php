    ...
    <div class="row row-pb-md">
        <div class="col-md-6 col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
            <form action="payment.php" method="post">
                ...
                <div class="row form-group">
                    <div class="col-md-12">
                        <label class="sr-only" for="email">Time</label>
                        <select class="form-control"><option>10:00AM</option>
                            ...
                            <option>03:00 AM - 04:00 PM</option>
                            <option>04:00 AM - 05:00 PM</option>
                            <option>05:00 AM - 06:00 PM</option>
                            <option>06:00 AM - 07:00 PM</option>
                            <option>07:00 AM - 08:00 PM</option>

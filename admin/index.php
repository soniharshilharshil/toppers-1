...
?>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				...
				<div class="panel panel-blue panel-widget ">
					<div class="row no-padding">
						...
						<i class="fa fa-user-plus fa-lg fa-4" style="font-size:50px;"></i>
						</div>
	...
	<div class="panel panel-orange panel-widget">
					<div class="row no-padding">
						...
						<div class="col-sm-3 col-lg-5 widget-left">
							<i class="fa fa-user fa-lg fa-4" style="font-size:50px;"></i>
						</div>
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">
                            <?php echo $cus; ?>
			...
			<a href="productshow.php">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						<div class="col-sm-3 col-lg-5 widget-left">
							<i class="fa fa-users fa-lg fa-4" style="font-size:50px;"></i>
						</div>
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">
                                <?php echo $pro;?>
		...
		<div class="col-xs-12 col-md-6 col-lg-3">
			<a href="rej.php">
				<div class="panel panel-red panel-widget">
					<div class="row no-padding">
						<div class="col-sm-3 col-lg-5 widget-left">
							<i class="fa fa-times fa-lg fa-4" style="font-size:50px;"></i>
						</div>
						<div class="col-sm-9 col-lg-7 widget-right">
							<div class="large">

...
<div id="page">
    ...
    <div class="div-cart-container-subcat" style="text-align:left;">
            <div class="subcat-text"><h2>Cleaning Material</h2></div>
        </div>

    <div class="div-parent-block">

        <a href="beardo---mustache-and-beard-wax-50gm/10.html">
            <div class="div-product-item">
                <div class="div-product-img">
                    <img src="images/product/8fc2d45f-8e8a-43e1-b710-717c2237143a_site.jpg" width="100%" />
                </div>
                <div class="div-prod-title">BEARDO - MUSTACHE AND BEARD WAX 50GM</div>
                <div class="div-prod-price-cat">Cleaning Material</div>
                <div class="div-prod-price">₹650</div>
            </div>
        </a>
    </div>

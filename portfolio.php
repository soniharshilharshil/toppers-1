...
<html>
	...
	<title>The Toppers/Portfolio</title>
				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc">
							...
							<h2 class="animate-box" data-animate-effect="fadeInUp">now you can see the our work <em>by</em> <a href="http://gettemplates.co/" target="_blank">GetTemplates.co</a></h2>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="gtco-container">
					...
					<ul id="gtco-portfolio-list">
						<li class="two-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/img_1.jpg); "> 
							<a href="#" class="color-1">
								<div class="case-studies-summary">
									<span>Hair cut</span>
									<h2>View the Sample of hair-cur</h2>
								</div>
							</a>
						</li>
						<li class="one-third animate-box" data-animate-effect="fadeIn" style="background-image: url(images/img_2.jpg); ">
							<a href="#" class="color-2">
								<div class="case-studies-summary">
									<span>Nail</span>
									<h2>The artits can do best Nail</h2>
								</div>
							</a>
						</li>
						...
						<li class="one-half animate-box" data-animate-effect="fadeIn" style="background-image: url(images/img_3.jpg); ">
							<a href="#" class="color-3">
								<div class="case-studies-summary">
									<span>Facial</span>
									<h2>The face facial are the best thing in our salon</h2>
								</div>
							</a>
						</li>
			...
			<div class="row">
				<div class="col-md-4 col-md-offset-4 text-center animate-box">
					<a href="#" class="btn btn-primary btn-lg btn-block">Have booked appointment? Let's get started</a>
				</div>
			</div>
			...
			<div class="row copyright">
				<div class="col-md-12">
					<p class="pull-left">
						...
						<small class="block">Designed by VAIBHAV HARSHIL SUNIL</small>
					</p>
					<p class="pull-right">
